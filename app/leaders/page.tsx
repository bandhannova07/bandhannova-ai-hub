        ...
        <div className="leaders-container">
            ...
            >
                ...
                >
                    ...
                    {/* Settings Button */}
                    <Button
                        onClick={() => router.push('/leaders/settings')}
                        variant="ghost"
            ...
            >
                ...
                >
                    <h1 className="leaders-chat-title">
                        Welcome, <span className="gradient-text">{currentUser?.user_metadata?.full_name || 'Leader'}</span>! 👋
                    </h1>
                </motion.div>
