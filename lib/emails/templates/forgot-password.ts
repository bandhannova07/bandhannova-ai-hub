...
export function getForgotPasswordHTML(name: string, resetToken: string): string {
                    ...
                    <tr>
                        <td style="padding: 20px 40px 40px;">
                            ...
                            <p style="margin: 0 0 20px; color: #b0b0b0; font-size: 16px; line-height: 1.6;">
                                We received a request to reset your password for your BandhanNova account. Click the button below to create a new password:
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding: 30px 0;">
                                        <a href="${resetLink}" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 15px rgba(102, 126, 234, 0.4);">
                                            Reset Password →
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 0; color: #b0b0b0; font-size: 14px; line-height: 1.6;">
                                            This link will expire in <strong style="color: #ffffff;">1 hour</strong>. If you didn't request this, please ignore this email and your password will remain unchanged.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            
                            <p style="margin: 20px 0 0; color: #808080; font-size: 13px; line-height: 1.6;">
